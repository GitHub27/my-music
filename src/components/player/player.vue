    ...
    <div class="player-control">
        ...
        <div class="mod-song-control grid">
            <div class="progress-wrapper">
                <span class="ticker cur">00:17</span>
                <div class="progress">
                    <div class="bar noUi-target noUi-ltr noUi-horizontal noUi-connect" @click="programBarClick">
                        <div class="noUi-base">
                            <div class="noUi-origin noUi-background" :style="{left: percent+'%'}">
